...
const Users = () => {
  ...
  const handleDelete = async (userId) => {
    ...
    try {
      ...
      showNotification('🗑️ Kullanıcı silindi!', 'success');
      fetchUsers();
    } catch (error) {
      console.error('Silme işlemi başarısız:', error);
      showNotification(error.response?.data?.message || 'Kullanıcı silinemedi', 'error');
    }
  };
  ...
  return (
    <div>
                ...
                <td className="px-6 py-4">
                  <div className="text-sm text-gray-900">
                    {user.departments && user.departments.length > 0 ? (
                      ...
                      <span className="text-gray-400">Birim atanmamış</span>
                    )}
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
      ...
      {/* Modal - (Kodun geri kalanı aynı, sadece alert'leri kaldırdık) */}
      {showModal && (
